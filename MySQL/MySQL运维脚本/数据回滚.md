...
my2sql -user dba -password xx -host yy -port 3306 \
  -mode file \
  -local-binlog-file "./mysql-bin.000003,./mysql-bin.000004,./mysql-bin.000005" \
  -start-file mysql-bin.000003 \
  -start-datetime "2024-03-13 18:20:00" \
  -stop-datetime "2024-03-13 18:25:00" \
  -tables "testtb" \
  -sql delete \
  -work-type rollback \
  -output-dir ./
